...
class Solution(object):
    ...
    def __init__(self, routes=[], cost=0, is_valid=False, demand=0):
        ...
        # routes_copy=[]
        # for i in routes:
        #     routes_copy.append(i.route)
        # # print("Before sort:",routes_copy)
        # routes_copy.sort()
        # # print("After sort:",routes_copy,str(routes_copy))
        # self.md5 = hashlib.md5(str(routes_copy)).hexdigest()
        # # print(self.md5)
...
class CVRPInfo(object):
    ...
    #刷新solution中的cost、demand等属性
    def refresh(self, solution):
        solution.hashV = solution.hash()
